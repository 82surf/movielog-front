<template>
  <div class="sw-container mt-5">
    <div class="by-follower-header-container">
      <h2 class="by-follower-header">내 친구들이 본 영화</h2>
    ...
    <swiper :options="swiperOptions">
      <swiper-slide
        ...
        :data-bs-target="`#FollowModal${movie.id}`"
...
.sw-container .by-follower-header-container .color-box {
  position: absolute;
  height: .8rem;
  width: 0;
  top: 18px;
...
.sw-container:hover .by-follower-header-container .color-box {
  width: 15rem;
}
.poster-container {
  position: relative;
